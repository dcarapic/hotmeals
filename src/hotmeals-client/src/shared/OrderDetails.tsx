        ...
        <div>
            ...
            {!props.disabled && (
                <div className="ms-1 mb-1 d-flex justify-content-end mb-1">
                    ...
                    {!isPlacedOrder(props.order) && !user.isRestaurantOwner && (
                        <Button
                            size="sm"
                            className="me-1"
                            variant="secondary"
                    ...
                    {hasStatus(props.order, "Placed") && !user.isRestaurantOwner && (
                        <Button
                            size="sm"
                            className="me-1"
                            variant="danger"
                    ...
                    {hasStatus(props.order, "Accepted") && user.isRestaurantOwner && (
                        <Button
                            size="sm"
                            variant="primary"
                            className="me-1"
                    ...
                    {hasStatus(props.order, "Shipped") && user.isRestaurantOwner && (
                        <Button
                            size="sm"
                            variant="primary"
                            className="me-1"
                    ...
                    {hasStatus(props.order, "Delivered") && !user.isRestaurantOwner && (
                        <Button
                            size="sm"
                            variant="primary"
                            className="me-1"
                    ...
                    {user.isRestaurantOwner && isPlacedOrder(props.order) && (
                        <Button
                            size="sm"
                            variant="warning"
                            className="me-1"
